...
<!-- Lean version v2: red-teamed by Codex HIPAA review 2026-04-02 -->
<!-- Source: context_nate/outputs/06-token-usage-findings/02-outcome-based-rewriter.md -->
<!-- Red team: Codex GPT-5.4 HIPAA compliance review — 3 items restored -->
...
**Code standards (security-relevant):**
- Python: use logging module, not print — print can leak PHI to stdout
- TypeScript: strict mode — enforces auth/tenant boundary safety
