# Prompt 2: Rules File Generator — MyBCAT Universal
**Generated: 2026-03-16 | Source: Nate's Newsletter "Your AI coding agent deleted 2.5 years of customer data"**
**Grown from: documented incidents, tech handover transcripts, security audit findings, agent mistakes**
...
**Primary location:** `/mnt/d_drive/repos/context_nate/outputs/CLAUDE-UNIVERSAL.md`
**Symlink into each active repo root:**
```bash
ln -sf /mnt/d_drive/repos/context_nate/outputs/CLAUDE-UNIVERSAL.md /mnt/d_drive/repos/mybcat-new/CLAUDE.md
ln -sf /mnt/d_drive/repos/context_nate/outputs/CLAUDE-UNIVERSAL.md /mnt/d_drive/repos/mybcat_brain/CLAUDE.md
```
For Claude Code: `CLAUDE.md` in project root (auto-loaded every session).

---

## How to Grow This

Every time your agent makes a mistake you've seen before — like the Bland AI edge label bug, the insurance credentials in chat, or the 0.0.0.0/0 security group — add one line to prevent it. This file should grow from scars, not brainstorming. Keep it under 100 lines. When it gets longer, tighten the language. Every line competes for your agent's context window, so brevity is a feature.

**Current line count: 48 lines (well within the 100-line target)**
